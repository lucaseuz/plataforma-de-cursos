...
# Comando para desativar temporiariamente as verificações de chaves estrangeiras (ERRO mysql.connector.errors.IntegrityError: 1452)
...
# Comando para ativar as verificações de chaves estrangeiras   
